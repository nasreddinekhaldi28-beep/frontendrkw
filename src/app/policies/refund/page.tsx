  ...
  return (
    <div className="max-w-3xl mx-auto px-4 py-12">
      ...
      <div className="bg-green-50 border border-green-200 rounded-xl p-5 mb-8">
        <p className="font-bold text-green-700 text-lg">🛡️ ضمان ذهبي 30 يوم بدون أسئلة</p>
        <p className="text-green-600 text-sm mt-1">إذا لم تكن راضياً عن المنتج لأي سبب خلال 30 يوم من الاستلام، نعيد لك المبلغ كاملاً.</p>
      </div>
      ...
      <div className="space-y-5 text-gray-700 text-sm leading-relaxed">
        <section>
          ...
          <ul className="list-disc list-inside space-y-1">
            ...
            <li>خلال 30 يوم من تاريخ الاستلام.</li>
        ...
        <section>
          ...
          <p>تواصل معنا خلال 30 يوم من استلام الطلب. سنرتب معك موعد الاسترداد مجاناً.</p>
        </section>
      </div>
    </div>
  );
