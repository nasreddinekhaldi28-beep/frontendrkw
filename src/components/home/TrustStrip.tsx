  ...
  return (
    <section className="bg-white border-y border-gray-100 py-6">
      <div className="max-w-6xl mx-auto px-4">
        <div className="grid grid-cols-2 md:flex md:flex-wrap md:items-center md:justify-between gap-3 md:gap-0">
          {badges.map((b) => (
            <div key={b.title} className="flex items-center gap-3 px-3 md:px-4 py-2 md:py-1 rounded-xl hover:bg-gray-50 transition-colors">
